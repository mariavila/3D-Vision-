...
F_gt = [0 -t(3) t(2);
       t(3) 0 -t(1);
       -t(2) t(1) 0;] * R; % ToDo: write the expression of the real fundamental matrix for P1 and P2
...
idx_car_I1 = 1197;
idx_car_I2 = matches1_2(2,matches1_2(1,:)==idx_car_I1); % ToDo: identify the corresponding point of idx_car_I1 in image 2
idx_car_I3 = matches1_3(2,matches1_3(1,:)==idx_car_I1); % ToDo: identify the corresponding point of idx_car_I1 in image 3
idx_car_I4 = matches1_4(2,matches1_4(1,:)==idx_car_I1); % ToDo: identify the corresponding point of idx_car_I1 in image 4
