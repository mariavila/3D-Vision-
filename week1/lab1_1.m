...
[U,D,V] = svd(C_inf);
SS = [sqrt(D(1,1)) 0 0; 0 sqrt(D(2,2)) 0 ;0 0 10]*[1 0 0; 0 1 0; 0 0 D(3,3)/100]*[sqrt(D(1,1)) 0 0; 0 sqrt(D(2,2)) 0 ;0 0 10]
SS(3,3) = 10
U = V';
H = U'*SS;

[I3,x_min, x_max, y_min, y_max ] = apply_H(I, H);
figure; imshow(I3);